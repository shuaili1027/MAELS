...
if __name__ == "__main__":
    ...
    parser.add_argument("--hot_path", type=str, default="-", help="-")
    parser.add_argument("--target_file", type=str, default="-", help="-")
    parser.add_argument("--file", type=str, default="Mnist", help="-")
    ...
    parser.add_argument("--using_AT_ND", type=bool, default=True, help="-")
    ...
    parser.add_argument("--noise_dim", type=int, default=132, help="normal noise")
    ...
    parser.add_argument("--seed", type=int, default=2023924, help="random seed for reproducibility")  # 1355
    # 5 samplings： 2023920-2023924
