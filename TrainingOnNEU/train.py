...
if __name__ == "__main__":
    ...
    #     for j in [0.0001,0.00015,0.0002,0.0003,0.0004]:
    ...
    parser.add_argument("--file", type=str, default="NEU-CLS", help="using database")
    ...
    parser.add_argument("--stage", type=str, default="stage2", help="selecting the stage1, stage21, or stage22")
    ...
    parser.add_argument("--d_lr", type=float, default=0.00002, help="-")
    parser.add_argument("--c_lr", type=float, default=0.00001, help="-")
    parser.add_argument("--info_lr", type=float, default=0.0001, help="-")
    ...
    parser.add_argument("--max_epoch", type=int, default=1000, help="-")
